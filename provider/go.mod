module github.com/pulumi/pulumi-external/provider
...
require (
	...
	github.com/terraform-providers/terraform-provider-external v0.0.0
)
...
replace github.com/terraform-providers/terraform-provider-external => ../upstream
