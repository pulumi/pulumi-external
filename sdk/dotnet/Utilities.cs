...
namespace Pulumi.External
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.External.version.txt");
    ...
    internal sealed class ExternalResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public ExternalResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
